...
{
    public class MyContext:IdentityDbContext<AppUser,AppRole,string> //string yazmamızın nedeni TKey is a string!
    {
        //Bir önceki projede DbContext'ten kalıtım aldık. Bu projede ise Identity'ye ait tabloları kullanabilmek için IdentityDbContextten kalıtım aldık
